...
const addCardsUbicaciones = () => {
    ...
    let imprimirUbicaciones = document.getElementById("productosPrint")
    ...
    listaUbicaciones.forEach(element => {
        ...
        <div class="card-body">
            ...
            <p class="card-text">${element.temperatura}</p>
        </div>
        </div>
        `
    });
...
let addTransporte = () => {
    ...
    let tipoTransporte = document.getElementById("tipoVehiculo").value;
...
mensaje = (a, b, c) => {
    console.log(`El costo en combustible para recorrer ${listaUbicaciones[2].km}km desde ${listaUbicaciones[0].ciudad} hacia ${listaUbicaciones[2].ciudad}en ${c} vehícluos es de $${a}, deberá realizar aproximadamente ${b} paradas a cargar combustible. La temperatura en la ciudad de destino ${listaUbicaciones[2].ciudad} es de ${listaUbicaciones[2].temperatura}, ${listaUbicaciones[2].descrip} `);

    const mostrarMSJ = document.createElement("h3");
    
    mostrarMSJ.setAttribute("id","elementoAgregado");

    mostrarMSJ.textContent = `El costo en combustible para recorrer ${listaUbicaciones[2].km}km desde ${listaUbicaciones[0].ciudad} hacia ${listaUbicaciones[2].ciudad} en ${c} vehículos es de $${a}, deberá realizar aproximadamente ${b} paradas a cargar combustible. La temperatura en la ciudad de destino ${listaUbicaciones[2].ciudad} es de ${listaUbicaciones[2].temperatura}, ${listaUbicaciones[2].descrip} `;
